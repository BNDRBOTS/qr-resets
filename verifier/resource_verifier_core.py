...
def safe_md(s: str) -> str:
    # Markdown summary is a portable human-readable view; machine-readable outputs retain
    # the original Unicode text. Strip pictographic/symbol glyphs here so the packaged
    # summary stays compatible with the repository's text-only release contract.
    cleaned = re.sub(r"[\U0001F000-\U0001FAFF\u2600-\u27BF\uFE0F]", "", normalize_space(s))
