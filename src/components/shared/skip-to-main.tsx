...
export function SkipToMain() {
  ...
  return (
    <a
      href="#main-content"
      onClick={handleClick}
      className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:rounded-full focus:border focus:border-primary/50 focus:bg-card focus:px-5 focus:py-2.5 focus:text-sm focus:font-medium focus:text-foreground focus:shadow-[var(--shadow-accent-soft)] focus:outline-none focus:ring-2 focus:ring-primary/60"
    >
