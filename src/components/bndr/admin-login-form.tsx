  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (result.kind === "success") {
        // NextAuth has already set the session cookie. Force a real browser
        // request to the sanitized admin callback so the cookie is presented
        // to both the proxy and server-side /admin authorization gate.
