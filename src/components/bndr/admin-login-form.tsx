...
import { ArrowLeft, Loader2, Lock, Mail, ShieldCheck, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="relative flex min-h-screen min-h-[100svh] flex-col items-center justify-center overflow-hidden bg-background px-4 py-10 sm:px-6">
      ...
      <div className="w-full max-w-sm">
        <Link
          href="/"
          className="mb-5 inline-flex min-h-11 items-center gap-2 rounded-full px-2 text-sm font-medium text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
        >
        ...
        <div className="mb-6 flex flex-col items-center gap-3">
          ...
          <p className="text-center text-sm text-muted-foreground">
            Secure access to the ResourceCite admin console.
          </p>
        </div>
